...
enum ActionType { MOVE, SCAN, PING, EXPLOIT, TRANSFER, WAIT, USE_PROGRAM, DISRUPT, HIDE, SPOOF, ATTACK_PROCESS, BREAK_LOCK, REDIRECT, TRACE_SCRAMBLE, RETREAT, DUMP_SAN }
