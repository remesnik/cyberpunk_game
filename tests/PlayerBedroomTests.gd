extends Node
const REQUIRED_IDS: Array[StringName] = [&"WINDOW_TABLE", &"WINDOW", &"DESK", &"BED", &"DOOR", &"POSTER_VIRUS", &"POSTER_PHREAKER", &"POSTER_WAREZ", &"STARTER_DECK_BOX", &"TOOLBOX", &"DISPLAY_TABLE", &"BOOKSHELF", &"JACK_IN_INTERFACE"]
var failures := 0
var assertions := 0
